...
gulp.task("images", () => {
   return gulp
      .src(paths.build.images, { allowEmpty: true })
      .pipe(clean())
...
gulp.task("icons", () => {
   return gulp
      .src(paths.build.icons, { allowEmpty: true })
      .pipe(clean())
...
gulp.task("fonts", () => {
   return gulp
      .src(paths.build.fonts, { allowEmpty: true })
      .pipe(clean())
...
gulp.task(
   "build",
   gulp.series("images", "icons", "html", "css", "fonts", "scripts")
);
